      ...
      { ({theme}) => (
        <div className="column player">
          ...
          <div className={`row bg-${theme}`}>
            ...
            <button className="btn-clear flex-center" onClick={onReset}><FaTimesCircle color="rgb(194,57,42)" size={26} /></button>
          </div>
        </div>
      )}
    </ThemeConsumer>
...
export default class Battle extends Component {
  constructor(props) {
    ...
    this.playersReset = this.playersReset.bind(this);
  ...
  handleSubmit(id, player) {
    ...
    console.log('submitted', player, id);
  }
